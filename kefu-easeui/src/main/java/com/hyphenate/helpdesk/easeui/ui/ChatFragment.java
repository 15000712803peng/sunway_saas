...
public class ChatFragment extends BaseFragment implements ChatManager.MessageListener {
    ...
    protected static final int ITEM_ORDER = 5;
    private static final int ITEM_MAP = 11;
    private static final int REQUEST_CODE_SELECT_MAP = 11;
    protected int[] itemStrings = {R.string.attach_take_pic, R.string.attach_picture/*,R.string.attach_location,R.string.attach_order, R.string.attach_video, R.string.attach_file*/};
    protected int[] itemdrawables = {R.drawable.hd_chat_takepic_selector, R.drawable.hd_chat_image_selector/*,R.drawable.hd_chat_location_selector, R.drawable.hd_chat_order_selector, R.drawable.hd_chat_video_selector, R.drawable.hd_chat_file_selector*/};

    protected int[] itemIds = {ITEM_TAKE_PICTURE, ITEM_PICTURE/*,ITEM_MAP,ITEM_ORDER, ITEM_VIDEO, ITEM_FILE*/};
...
//        titleBar.setRightImageResource(R.drawable.hd_mm_title_remove);
    ...
    protected void onConversationInit() {
        ...
        if (conversation != null) {
            ...
            getActivity().sendBroadcast(new Intent("com.cnsunway.saas.wash.filter_has_new_hx_message"));
...
//                startActivityForResult(new Intent(getActivity(), BaiduMapActivity.class), REQUEST_CODE_SELECT_MAP);
    ...
    protected void selectPicFromCamera() {
        ...
        if (Build.VERSION.SDK_INT <= Build.VERSION_CODES.M) {
            ...
            intent.putExtra(MediaStore.EXTRA_OUTPUT, FileProvider.getUriForFile(getContext().getApplicationContext(), "com.cnsunway.saas.wash.fileprovider", cameraFile));
        }
