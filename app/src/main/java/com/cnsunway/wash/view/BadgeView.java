...
public class BadgeView extends TextView {
    ...
    private static final int defaultWidthDp = 22;
    private static final int DEFAULT_CORNER_RADIUS_DIP = 11;
    private static final int DEFAULT_POSITION = POSITION_TOP_RIGHT;
    private static final int DEFAULT_BADGE_COLOR = Color.parseColor("#2ed0d3"); //Color.RED;
    ...
    private void applyTo(View target) {
        ...
        if (target instanceof TabWidget) {
            ...
            ((ViewGroup) target).addView(container,
                    new LayoutParams(LayoutParams.MATCH_PARENT, dipToPixels(50)));
    ...
    private void applyLayoutParams() {
        ...
        FrameLayout.LayoutParams lp = new FrameLayout.LayoutParams(dipToPixels(defaultWidthDp), dipToPixels(defaultWidthDp));
