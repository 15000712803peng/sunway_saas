...
import com.cnsunway.wash.dialog.CancelOrderDialog2;
...
import com.cnsunway.wash.model.DirectInfo;
...
import com.cnsunway.wash.resp.ShareKeyResp;
...
import com.cnsunway.wash.view.MySeekBar;
...
//                        }
            ...
            case Const.Message.MSG_PROGRESS_INCREASED:
            {
                ...
                if(currentProgress < progress){
                    ...
                    handler.sendEmptyMessageDelayed(Const.Message.MSG_PROGRESS_INCREASED,50);
                }else {
