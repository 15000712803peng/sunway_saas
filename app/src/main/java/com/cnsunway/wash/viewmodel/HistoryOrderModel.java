 ...
 */
public class HistoryOrderModel extends ViewModel{
    ...
    public static void setActivity(Activity activity) {
        HistoryOrderModel.activity = activity;
    }
            ...
            case Const.Message.MSG_ORDER_DONE_SUCC:
                if (msg.arg1 == Const.Request.REQUEST_SUCC) {
                    ...
                    if(searchData != null) {
                        ...
                        if (searchData.getPaginator().getPage() == 1 || getHomeLists() == null || initOrders == null) {
    ...
    public void requestData(Activity activity){
        ...
        orderDoneVolley.requestGet(Const.Request.donePage,
