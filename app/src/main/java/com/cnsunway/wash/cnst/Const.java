package com.cnsunway.wash.cnst;

public class Const {
    public static final String TOKEN_TEST = "2e0963ca976d11e5b1fa8038bc0b555d";
    public static final String EMPTY = "";
    private static final String PACKAGE_NAME = "com.cnsunway.wash";
...
//        public static final String WX_SERVER = "http://wx.landaojia.com/ldj-app";
        ...
        public static void setServer(String baseUrl) {
            ...
            deleteAddr = SERVER + "/useraddresses/delete";
            creaetAddr = SERVER + "/useraddresses/create";
            updateAddr = SERVER + "/useraddresses/update";
            showDefaultAddr = SERVER + "/useraddresses/show_default";
            all = SERVER + "/accounts/all";
            pay = SERVER + "/accounts/pay";
            confirmPay = SERVER + "/pay/confirmPay";
            confirmDone = SERVER + "/orders/confirmDone";
            payCancel = SERVER + "/pay/cancel";
            ...
            priceList = SERVER.replace("/ldj-app", "/") + "#/tabs/priceList";
            storeShow = SERVER.replace("/ldj-app", "/") + "market/homeLinks/storeShow.html";
            agreement = SERVER.replace("/ldj-app", "/"       ) + "index.html#/tabs/agreement";
            question = SERVER.replace("/ldj-app", "/") + "index.html#/tabs/questions";
            about = SERVER.replace("/ldj-app", "/") + "index.html#/tabs/about";
            balance = SERVER.replace("/ldj-app", "/") + "market/new_balance/balance.html";
            ...
            newBalance = SERVER.replace("/ldj-app", "/") + "market/new_balance/index.html";
            serviceprocess = SERVER.replace("/ldj-app", "/") + "market/homeLinks/serviceProcess.html";
            servicerange = SERVER.replace("/ldj-app", "/") + "#/servicerange";
            healthwash = SERVER.replace("/ldj-app", "/") + "market/homeLinks/healthWash.html";
