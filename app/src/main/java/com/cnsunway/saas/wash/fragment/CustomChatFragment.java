...
import com.cnsunway.saas.wash.activity.ContextMenuActivity;
import com.cnsunway.saas.wash.activity.SendLocalActivity;
import com.cnsunway.saas.wash.cnst.Const;
import com.cnsunway.saas.wash.widget.chatrow.ChatRowEvaluation;
import com.cnsunway.saas.wash.widget.chatrow.ChatRowForm;
import com.cnsunway.saas.wash.widget.chatrow.ChatRowLocation;
import com.cnsunway.saas.wash.widget.chatrow.ChatRowOrder;
import com.cnsunway.saas.wash.widget.chatrow.ChatRowTrack;
...
public class CustomChatFragment extends ChatFragment implements ChatFragment.EaseChatFragmentListener {
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        getActivity().sendBroadcast(new Intent(Const.MyFilter.FILTER_HAS_NEW_HX_MESSAGE));
...
//            startActivity(intent);
    ...
    public boolean onExtendMenuItemClick(int itemId, View view) {
        switch (itemId) {
            case ITEM_MAP: //地图
                startActivityForResult(new Intent(getActivity(), SendLocalActivity.class), REQUEST_CODE_SELECT_MAP);
                break;
...
//        inputMenu.registerExtendMenuItem(R.string.attach_order, R.drawable.hd_chat_order_selector, ITEM_ORDER, extendMenuItemClickListener);
