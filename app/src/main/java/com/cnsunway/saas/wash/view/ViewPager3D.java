	...
	protected boolean getChildStaticTransformation(View child, Transformation t)
	{
		...
		else if (mScrollPositionOffset > 0)
		{
			...
			if (mTempTect.left >= mScrollPositionOffsetPixels)
			{
				...
				{
					t.setTransformationType(Transformation.TYPE_BOTH);
					t.setAlpha((float) Math.sin((float) (mScrollPositionOffset * Math.PI / 2)));
				}
				// right side
			...
			else if (mTempTect.left == 0)
			{
				...
				{
					t.setTransformationType(Transformation.TYPE_BOTH);
					t.setAlpha((float) Math.sin((float) (mScrollPositionOffset * Math.PI / 2 + Math.PI / 2)));
				}
				// left side
